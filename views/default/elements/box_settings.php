<div class="box-settings-wrapper">
    <div class="box-settings">
        <span>Settings</span>
        <div class="box-settings-content">
            <span class="box-settings-option delete-box">Delete this box</span><br>
            <span class="box-settings-option update-box-content">Choose content</span>
        </div>
    </div>
